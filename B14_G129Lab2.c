        ...
        switch(test_state) {
            ...
            case MOTOR_FORWARD:
                ...
                if (button2_pushed && getMotorEncoder(motor1) >= 3000) {
                    // If button 2 pushed and the motor has turned 3000 points, transition to MOTOR_STOP state.
                		resetMotorEncoder(motor1);//reset the encoder to get it ready to count the rotation.
            ...
            case MOTOR_BACKWARD:
                ...
                if (button1_pushed && getMotorEncoder(motor1) <= -3000) {
                    // If button 2 pushed and after completeion of 3000 points of rotation, transition to MOTOR_STOP state.
                		resetMotorEncoder(motor1);//reset the encoder to get it ready to count the rotation.
